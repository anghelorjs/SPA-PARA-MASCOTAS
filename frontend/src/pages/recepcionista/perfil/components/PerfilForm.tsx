// src/pages/recepcionista/perfil/components/PerfilForm.tsx
    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-500">Turno</label>
            <p className="mt-1 text-gray-900">{initialData.turno_descripcion}</p>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-500">Citas gestionadas hoy</label>
            <p className="mt-1 text-gray-900">{initialData.citas_gestionadas_hoy}</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="mt-4 text-sm text-gray-500">
        <p>⚠️ El turno es asignado por el administrador y no puede ser modificado aquí.</p>
      </div>
    </div>
  );
};